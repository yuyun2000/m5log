...
python safetensor_infer.py \
    --input_path "./s/AnythingXL_v50.safetensors" \
    --lora_path "./s/WashPainting_v1.0.safetensors" \
    --output_path "./test_output" \
    --prompt "Asian rural landscapes, traditional farming, rice paddies, farmers with conical hats, reflections on water, distant mountains, sunrise, mist, soft tones, serene atmosphere, traditional clothing, artwork, illustrations, horizontal compositions, calm water, nature, outdoors, serenity," \
    --lora_scale 0.5
```
